...
(function (exp) {
    exp.$galen = $galen;
    exp.testOnAllDevices = testOnAllDevices;
    exp.testOnDevice = testOnDevice;
    exp.checkLongWordsLayout = checkLongWordsLayout;
    exp.checkImageDiff = checkImageDiff;
    exp.checkMultiSizeLayout = checkMultiSizeLayout;
})(this);
